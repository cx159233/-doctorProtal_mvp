 ...
 * @Date: 2025-06-23 16:45:33
 * @LastEditors: ranfenghua ranfenghua@cecinvestment.com
 * @LastEditTime: 2025-06-25 14:12:12
 * @FilePath: /jskydy-org-view/src/views/home/config.js
 * @Description: 
 * 
...
二、【账号与密码安全】 
2.1您在使用本服务前需要由${window.CONFIG.source.text}医疗资源保障局或我方完成首次账户密码登录授权，再由您使用本人身份信息做二次鉴权验证。
...
16.2 本协议签订地为中华人民共和国${window.CONFIG.source.detail}。 
...
常州健康医疗大数据运营有限公司 2025年 9月22日 数据隐私权政策 本《数据隐私权政策》（“本政策”）由中电通商数字技术（上海）有限公司（为本政策之目的亦包括平台的运营方常州健康医疗大数据运营有限公司，下称“我方”）制定并发布。本政策作为您（下称“您”或“用户”）成为${window.CONFIG.source.text}个人医保云用户所需签订的《用户服务许可协议》的一部分。请您务必仔细阅读并透彻理解本政策，在确认充分理解并同意后再按照页面上的提示完成全部的二次鉴权程序。用户在进行二次鉴权程序过程中点击“同意”或“下一步”即表示用户完全接受本政策。如果您不同意本政策中的任何内容，或者无法准确理解我方对条款的解释，您应立即停止二次鉴权程序。 本政策将帮助您了解以下内容： 1.个人数据的范围和使用 2.个人数据的保护和处理 3.本政策如何更新 4.如何联系我方 一、个人数据的范围和使用 （一） 您如何使用患者医学影像数据 1. 本平台所提供的医学影像数据范围，包括${window.CONFIG.source.text}医疗资源保障局下属医疗机构（后续将不时加入其他医疗机构）集中向本平台上传的患者影像、报告等信息，以及在本平台运行中产生的或存储的患者其他数据信息（“患者医学影像数据”）。 2. 患者医学影像数据的使用 您在使用患者医学影像数据前，须获得以下授权或同意（特别地，如属于个人敏感信息，须获得明示授权或同意）： （1）${window.CONFIG.source.text}医疗资源保障局或相关法律法规规定的${window.CONFIG.source.text}卫生主管部门的授权或同意； （2）医疗机构的授权或同意； （3）患者本人的授权或同意，并由患者提供患者本人姓名及身份证号等证件号码。 3. 禁止泄密义务 您在使用患者医学影像数据时，需遵守相关法律法规的规定，并在患者本人同意或授权的范围内使用。未征得法律法规规定的合法授权主体同意或授权前，不得将本平台所提供的患者医学影像数据擅自透露给除患者以外的第三人。 （二） 我方如何收集和使用用户信息 1. 用户信息的收集 (1) 您在登录本平台时，平台会同步您所在单位系统的账户信息，并收集您职业医师、技师工号或身份证等信息方便您登录使用。 (2) 在您使用我方服务过程中，为保障您的账号安全、识别账号异常状态、向您提供更契合您需求的服务，我方可能会自动收集用户的使用情况并存储应用程序ID、医院标识、账户标识信息、被调阅患者记录，以及调阅时间等信息。 (3) 鉴于我方提供的服务需要依赖部分信息才能得以运行，若您选择使用我方的服务，则需要向我方提供或允许我方收集必要信息。如拒绝提供相应信息或进行相应的数据使用申请或授权，将无法正常使用我方的全部或部分服务。 2. 用户信息的使用 我方收集用户信息，将在以下情形中使用： (1) 提供本平台服务：为向您提供所需的服务，我方在您使用本平台服务的过程中将根据需求并受限于本政策而使用所收集到的相关用户信息。 在您使用我方服务过程中，为保障您的账号安全、识别账号异常状态、向您提供更契合您需求的服务，我方可能会自动收集用户的使用情况并存储为网络日志信息（包括但不限于设备信息和所在位置相关信息）和服务日志信息（包括但不限于浏览、点击查看、搜索查询、发布信息，以及IP地址、浏览器类型、电信运营商、使用语言、访问日期和时间）。请注意，单独的设备信息、服务日志信息是无法识别特定自然人身份的信息。 (2) 用于政府部门的数据监管：作为${window.CONFIG.source.text}医保影像云平台，本平台将用户上传、输入、记录、发布、生成于本平台的信息和数据依法定期汇报给相关政府主管部门用以实现对医学影像数据的实时动态监管、统计和分析。对于涉及个人信息的数据将脱敏处理后向相关政府主管部门披露。 (3) 提供安全保障及服务优化：为提高您使用我方及合作伙伴提供服务的安全性，保护用户人身财产安全免遭侵害，更好地预防钓鱼网站、欺诈、网络漏洞、计算机病毒、网络攻击、网络侵入等安全风险，更准确地识别违反法律法规或本平台相关协议规则的情况，我方可能使用或整合您的用户信息、上传、输入、记录、发布、生成于本平台的信息、设备信息、服务日志信息以及我方关联公司、合作伙伴取得您授权或依据法律共享的信息，来综合判断您的账号安全及使用情况，并依法采取必要的记录、审计、分析、处置措施。 为提升优化我方的服务，我方将基于您的操作行为对您的数据进行调查研究和分析。 二、个人数据的保护和处理 （一）个人数据保护 本平台根据国家法律法规的规定及相关主管部门的授权或同意，合法合理的收集、使用、处理患者医学影像数据及用户数据信息。您同意并遵守我方的包括但不限于以下个人数据保护制度或措施： 1. 本平台根据实际需要，为加强数据保护工作，制定数据相关管理制度。在该制度送达或通知您时，您应当遵守并执行； 2. 本平台会根据技术的不断迭代和发展，以及功能的优化，采取相应的个人数据的技术保护措施。您同意前述措施并在需要时更新相关软件或插件； 3. 其他应当采取的个人保护制度或措施。 （二）个人信息的处理 1. 对于平台收集的用户的个人信息及患者医学影像数据信息，除取得您或患者授权或法律法规另有规定外，我方会将这类信息做匿名化、去标识化处理。此外，我方也会为了不断改进和优化上述的功能来使用用户的上述信息。 2. 尽管我方会对个人信息进行脱敏处理，且不会向第三方提供用户信息未经脱敏的个人信息，但以下情况除外： （1）依法提供：我方可能会根据法律法规规定、诉讼、争议解决需要，或按行政、司法机关依法提出的要求（包括但不限于以下情形），向第三方提供个人信息且无需取得信息主体的同意： a) 与国家安全、国防安全有关的； b) 与公共安全、公共卫生、重大公共利益有关的； c) 用于相关政府部门进行数据监管的； d) 与犯罪侦查、起诉、审判和判决执行等司法或行政执法有关的； e) 出于维护您或其他个人的生命、财产等重大合法权益但又很难得到本人同意的； （2）经信息主体主动选择或明确同意后提供：经信息主体主动选择/申请或者在获得信息主体的明确同意后，我方会根据信息主体的申请/授权范围进行个人信息的使用。 （3）已成为公开信息：对于信息主体已向社会公众公开的个人信息，或可以从合法公开披露的信息中收集到的个人信息（如合法的新闻报道、政府信息公开等渠道），我方可以在未经信息主体同意的情况下向第三方提供。 （4）为完成合并、分立、收购或资产转让而转移的信息：若我方或平台的所有权人或运营单位发生合并、分立、收购或资产转让的，我方可以在未经信息主体同意的情况下将该个人信息根据合并、分立、收购或资产转让的需要转移至第三方。 （5）根据《用户服务许可协议》，我方/本平台有权提供个人信息的其他情形。 3. 为实现本平台的功能与服务所披露：为更好地实现本平台的服务与功能，我方可能委托授权合作伙伴为您提供某些服务或代表我方履行职能，授权合作伙伴只能接触到其履行职责所需信息，且不得将此信息用于其他任何目的。目前，我方的授权合作伙伴及合作类型为：我方将无法识别到个人的相关信息发送给支持我方业务的供应商、服务提供商和其他合作伙伴，这些支持包括受我方委托提供的技术基础设施服务、分析我方服务的使用方式、衡量服务的有效性、提供客户服务、支付便利或进行学术研究和调查。 三、本政策的更新 本政策可能在必要时进行更新。我方会将对本政策所做的任何变更及时通知到您，通知方式包括但不限于在本平台的上发布，向您提供弹窗提示，或通过邮件方式等其他合理方式。 四、如何联系我方 如果您对本协议或本服务有意见或建议，可发送邮件至lvpin@cecinvestment.com与我方联系，我方会给予您必要的帮助。 
`
const userSecert = `
本数据隐私权政策（以下称“隐私权政策”）将帮助您了解以下内容： 
1、 个人数据的范围和使用 
2、 个人数据的保护和处理 
3、 本隐私权政策如何更新 
4、 如何联系我们 一、个人数据的范围和使用 （一） 您如何使用患者医学影像数据 
1、${window.CONFIG.source.text}个人医保云目前提供的数挺范围包括常州市全部公立医疗机构及已接入本中心的医保定点医疗机构按统一标准向本中心上传的患者检查检验申请信息、检查检验报告信息、影像DICOM文件等患者医学检查检验数据。2、在调阅或使用患者医学检查检验数据前，需获得以下授权或同意(个人敏感信息，须获得明示授权或同意):（1）患者检查检验数据调阅和使用需符合《中华人民共和国数据安全法》、《网络数据安全管理条例》、《中华人民共和国个人信息保护法》，及国家和${window.CONFIG.source.text}有关数据安全与个人隐私相关管理办法等法律法规和管理办法。（2）常州市医疗保障局、常州市数据局、医疗机构等授权。（3）患者本人的授权或同意，并由患者提供患者本人姓名及身份证号。
3. 禁止泄密义务 您在使用患者医学影像数据时，需遵守相关法律法规的规定，并在患者本人同意或授权的范围内使用。未征得法律法规规定的合法授权主体同意或授权前，不得将本平台所提供的患者医学影像数据擅自透露给除患者以外的第三人。 （二） 我们如何收集和使用用户信息 1. 用户信息的收集 (1) 您在登录本平台时，平台会同步您所在单位系统的账户信息，并收集您个人账号等信息方便您登录使用。 (2) 在您使用我们服务过程中，为保障您的账号安全、识别账号异常状态、向您提供更契合您需求的服务，我们可能会自动收集用户的使用情况并存储应用程序ID、医院标识、账户标识信息、被调阅患者记录，以及调阅时间等信息。 (3) 鉴于我们提供的服务需要依赖部分信息才能得以运行，若您选择使用我们的服务，则需要向我们提供或允许我们收集必要信息。如拒绝提供相应信息或进行相应的数据使用申请或授权，将无法正常使用我们的全部或部分服务。 (4) 若用户提供的信息中含有非由用户控制或所有的个人信息及涉及第三方的保密信息，用户在向本平台提供这些个人信息、保密信息之前，应确保已取得合法授权且该等信息已脱密处理。 2. 用户信息的使用 我们收集用户信息，将在以下情形中使用： (1) 提供本平台服务 为向您提供所需的服务，我们在您使用本平台服务的过程中将根据需求并受限于本隐私权政策而使用所收集到的相关用户信息。 (2) 用于政府部门的数据监管 作为${window.CONFIG.source.text}个人医保云，本平台将用户上传、输入、记录、发布、生成于本平台的信息和数据依法定期汇报给相关政府主管部门用以实现对医学影像数据的实时动态监管、统计和分析。对于涉及个人信息的数据将脱敏处理后向相关政府主管部门披露。 (3)提供安全保障及服务优化为提高您使用我们及合作伙伴提供服务的安全性，保护用户人身财产安全免遭侵害，更好地预防钓鱼网站、欺诈、网络漏洞、计算机病毒、网络攻击、网络侵入等安全风险，更准确地识别违反法律法规或本平台相关协议规则的情况，我们可能使用或整合您的用户信息、上传、输入、记录、发布、生成于本平台的信息、设备信息、服务日志信息以及我们关联公司、合作伙伴取得您授权或依据法律共享的信息，来综合判断您的帐号安全及使用情况，并依法采取必要的记录、审计、分析、处置措施。为提升优化我们的服务，我们将基于您的操作行为对您数据进行调查研究和分析。 3. 禁止泄密义务 您在使用患者医学影像数据时，需遵守相关法律法规的规定，并在患者本人同意或授权的范围内使用。未征得法律法规规定的合法授权主体同意或授权前，不得将本平台所提供的患者医学影像数据擅自透露给除患者以外的第三人。 二、个人数据的保护和处理 （一）个人数据保护 本平台根据国家法律法规的规定及相关主管部门的授权或同意，合法合理的收集、使用、处理患者医学影像数据及用户数据信息。您同意并遵守我们的包括但不限于以下个人数据保护制度或措施： 1. 本平台根据实际需要，为加强数据保护工作，制定数据相关管理制度。在该制度送达或通知您时，您应当遵守并执行； 2. 本平台会根据技术的不断迭代和发展，以及功能的优化，采取相应的个人数据的技术保护措施。您同意前述措施并在需要时更新相关软件或插件； 3. 其他应当采取的个人保护制度或措施。 （二）个人信息的处理 1. 对于平台收集的用户的个人信息及患者医学影像数据信息，除取得您或患者授权或法律法规另有规定外，我们会将这类信息做匿名化、去标识化处理。此外，我们也会为了不断改进和优化上述的功能来使用用户的上述信息。 2. 尽管我们会对个人信息进行脱敏处理，且不会向第三方提供用户信息未经脱敏的个人信息，但以下情况除外： （1）依法提供：我们可能会根据法律法规规定、诉讼、争议解决需要，或按行政、司法机关依法提出的要求（包括但不限于以下情形），向第三方提供个人信息且无需取得信息主体的同意： (a) 与国家安全、国防安全有关的； (b) 与公共安全、公共卫生、重大公共利益有关的； (c) 用于相关政府部门进行数据监管的； (d) 与犯罪侦查、起诉、审判和判决执行等司法或行政执法有关的； (e) 出于维护您或其他个人的生命、财产等重大合法权益但又很难得到本人同意的； （2）经信息主体主动选择或明确同意后提供：经信息主体主动选择/申请或者在获得信息主体的明确同意后，我们会根据信息主体的申请/授权范围进行个人信息的使用。 （3）已成为公开信息：对于信息主体已向社会公众公开的个人信息，或可以从合法公开披露的信息中收集到的个人信息（如合法的新闻报道、政府信息公开等渠道），我们可以在未经信息主体同意的情况下向第三方提供。 （4）为完成合并、分立、收购或资产转让而转移的信息：若我们或平台的所有权人或运营单位发生合并、分立、收购或资产转让的，我们可以在未经信息主体同意的情况下将该个人信息根据合并、分立、收购或资产转让的需要转移至第三方。 （5）根据《用户服务许可协议》，我们/本平台有权提供个人信息的其他情形。 3. 为实现本平台的功能与服务所披露：为更好地实现本平台的服务与功能，我们可能委托授权合作伙伴为您提供某些服务或代表我们履行职能，授权合作伙伴只能接触到其履行职责所需信息，且不得将此信息用于其他任何目的。目前，我们的授权合作伙伴及合作类型为：我们将无法识别到个人的相关信息发送给支持我们业务的供应商、服务提供商和其他合作伙伴，这些支持包括受我们委托提供的技术基础设施服务、分析我们服务的使用方式、衡量服务的有效性、提供客户服务、支付便利或进行学术研究和调查。 （三）未成年人个人信息保护 1. 若您为未满18周岁未成年人，在使用我们相关服务前，应在您父母（或其他监护人）的监护、指导下共同阅读并同意本隐私权政策；特别地，若您为未满14周岁未成年人（“儿童”），应在您父母（或其他监护人）的监护、指导下共同阅读并同意本隐私权政策及《儿童隐私保护政策》。 2. 我们将根据国家法律法规关于保护未成年人个人信息的规定，在法律允许范围内及父母（或其他监护人）明确同意的情况下，收集、使用、共享或披露必要的未成年人个人信息；如我们发现在未事先获得父母（或其他监护人）的同意的情况下收集了未成年人的个人信息，我们会立即删除。 3. 若您是未成年人的父母（或其他监护人），当您对您所监护的未成年人使用我们的服务或其向我们提供的用户信息有任何疑问时，请随时与我们联系。 三、本隐私权政策的更新 我们的隐私权政策可能在必要时进行更新。我们会将对隐私权政策所做的任何变更及时通知到您，通知方式包括但不限于在本平台的上发布，向您提供弹窗提示，或通过邮件方式等其他合理方式。 四、如何联系我们 如果您对本协议或本服务有意见或建议，可与我们当地市场人员联系，我们会给予您必要的帮助
`
export default { userAgreement, userSecert }
