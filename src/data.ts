export const healthRecords = [
  { date: "2026-05-15", hosp: "常州市第一人民医院", dept: "心内科", type: "op", diag: "冠心病常规复诊", cost: "¥386", reimb: "¥268", tags: ["门诊"], desc: "1. 冠状动脉粥样硬化性心脏病 2. 高血压病3级（极高危）" },
  { date: "2025-03-22", hosp: "常州市第一人民医院", dept: "骨科", type: "op", diag: "腰椎间盘突出治疗", cost: "¥50", reimb: "¥45", tags: ["门诊"], desc: "腰椎间盘突出症 (L4/L5)" },
  { date: "2026-03-15", hosp: "常州市第一人民医院", dept: "心内科", type: "op", diag: "原发性高血压", cost: "¥386", reimb: "¥268", tags: ["门诊"], desc: "原发性高血压2级，血压控制欠佳，调整用药方案" },
  { date: "2025-02-10", hosp: "南京大学医学院附属鼓楼医院", dept: "消化内科", type: "op", diag: "慢性胃炎", cost: "¥50", reimb: "¥45", tags: ["门诊"], desc: "慢性浅表性胃炎，幽门螺杆菌阳性" },
  ...
  { date: "2025-03-10", dateEnd: "2025-03-20", hosp: "常州市第一人民医院", dept: "心内科", type: "ip", diag: "急性心肌梗死住院记录", cost: "¥12,450", reimb: "¥9,800", tags: ["住院"], desc: "主要诊断：入院后急诊PCI术，于前降支植入支架一枚。术后予以抗血小板、调脂、改善心肌重构等治疗。", status: "已出院" },
  ...
  { date: "2023-05-10", dateEnd: "2023-05-18", hosp: "常州市第一人民医院", dept: "普外科", type: "ip", diag: "阑尾炎住院", cost: "¥8,420", reimb: "¥6,230", tags: ["住院"], desc: "主要诊断：急性阑尾炎。行腹腔镜下阑尾切除术，术后恢复良好。", status: "已出院" },
  { date: "2022-12-01", dateEnd: "2022-12-11", hosp: "南京大学医学院附属鼓楼医院", dept: "呼吸内科", type: "ip", diag: "大叶性肺炎", cost: "¥5,600", reimb: "¥4,100", tags: ["住院"], desc: "主要诊断：大叶性肺炎。入院抗感染、对症支持治疗，病情好转。", status: "已出院" },
  { date: "2022-08-15", dateEnd: "2022-08-23", hosp: "常州市第一人民医院", dept: "消化内科", type: "ip", diag: "急性胃肠炎", cost: "¥3,200", reimb: "¥2,400", tags: ["住院"], desc: "主要诊断：急性胃肠炎伴中度脱水。予以补液、抗感染治疗。", status: "已出院" },
  { date: "2022-03-10", dateEnd: "2022-03-25", hosp: "常州市第一人民医院", dept: "骨伤科", type: "ip", diag: "左桡骨远端骨折", cost: "¥7,800", reimb: "¥5,900", tags: ["住院"], desc: "主要诊断：左桡骨远端骨折。行切开复位内固定术，术后石膏固定。", status: "已出院" },

  { date: "2026-05-16", hosp: "常州市第一人民医院", dept: "检验科", type: "lab", diag: "生化常规检查", cost: "¥120", reimb: "¥100", tags: ["检验"], metrics: [{label: "谷丙转氨酶 (ALT)", value: "45", unit: "U/L", flag: "high"}, {label: "总胆固醇 (TC)", value: "6.2", unit: "mmol/L", flag: "high"}], moreCount: 3 },
  { date: "2025-04-12", hosp: "南京大学医学院附属鼓楼医院", dept: "检验科", type: "lab", diag: "糖化血红蛋白", cost: "¥80", reimb: "¥60", tags: ["检验"], metrics: [{label: "糖化血红蛋白", value: "5.8", unit: "%", flag: ""}] },
  { date: "2026-03-15", hosp: "常州市第一人民医院", dept: "检验科", type: "lab", diag: "血常规 (五分类)", cost: "¥80", reimb: "¥60", tags: ["检验"], metrics: [{label: "白细胞 (WBC)", value: "7.2", unit: "10^9/L", flag: ""}, {label: "红细胞 (RBC)", value: "4.8", unit: "10^12/L", flag: ""}] },
  ...
  { date: "2026-05-16", hosp: "常州市第一人民医院", dept: "放射科", type: "exam", diag: "胸部CT平扫", cost: "¥240", reimb: "¥180", tags: ["检查", "放射科"], desc: "诊断结论：双肺纹理增多；建议结合临床，必要时随访。" },
  { date: "2025-03-12", hosp: "南京大学医学院附属鼓楼医院", dept: "超声科", type: "exam", diag: "心脏彩超", cost: "¥60", reimb: "¥40", tags: ["检查", "超声科"], desc: "诊断结论：左房稍大，左室壁节段性运动异常，EF 52%。" },
  { date: "2025-04-12", hosp: "南京大学医学院附属鼓楼医院", dept: "超声科", type: "exam", diag: "彩色多普勒超声", cost: "¥180", reimb: "¥140", tags: ["检查", "超声科"], desc: "结论：颈动脉内膜毛糙，未见明显斑块。建议定期复查。" },
  ...
  { date: "2026-05-17", hosp: "常州德仁堂药店", dept: "心内科", type: "med", diag: "长期用药处方", cost: "¥158", reimb: "¥120", tags: ["药耗"], items: [{name: "阿司匹林肠溶片", count: "1盒"}, {name: "阿托伐他汀钙片", count: "2盒"}], moreCount: 1 },
  { date: "2025-04-15", hosp: "常州万民药店", dept: "门诊部", type: "med", diag: "门诊处方详单", cost: "¥85", reimb: "¥65", tags: ["药耗"], items: [{name: "一次性使用无菌注射器 5ml", count: "1具"}] },
  { date: "2026-03-15", hosp: "常州德仁堂药店", dept: "心内科", type: "med", diag: "高血压用药", cost: "¥158", reimb: "¥120", tags: ["药耗"], items: [{name: "苯磺酸氨氯地平片", count: "2盒"}, {name: "缬沙坦胶囊", count: "1盒"}] },
  { date: "2025-02-10", hosp: "南京益丰大药房", dept: "消化内科", type: "med", diag: "胃病用药", cost: "¥85", reimb: "¥65", tags: ["药耗"], items: [{name: "奥美拉唑肠溶片", count: "1盒"}] },
  ...
  { id: "30", date: "2026-06-01", hosp: "常州爱康国宾体检中心", dept: "体检中心", type: "pe", diag: "年度员工健康体检", cost: "¥850", reimb: "¥0", tags: ["体检"], desc: "建议：1. 发现轻度脂肪肝，建议低脂饮食。2. 尿酸指标偏高，需控制嘌呤摄入。", metrics: [{label: "甘油三酯", value: "2.45", flag: "high"}, {label: "血尿酸", value: "468", flag: "high"}] },
  { id: "31", date: "2025-05-15", hosp: "常州美年大健康体检中心", dept: "体检中心", type: "pe", diag: "专项防癌筛查体检", cost: "¥1200", reimb: "¥0", tags: ["体检"], desc: "诊断：各项指标在正常范围内，未见明显异常。" },
